...
public class LoadoutManager : MonoBehaviour
{
    ...
    public void DisplayTankSelection()
    {
        if (currentTankSelection == 0)
        {
            ...
            handleLoadout.playerHealth.maxHealth = tankBodySelection.tankHealthStat01;
        }
        if (currentTankSelection == 1)
        {
            ...
            handleLoadout.playerHealth.maxHealth = tankBodySelection.tankHealthStat02;
        }
        if (currentTankSelection == 2)
        {
            //Change sprite
            ...
            handleLoadout.playerHealth.maxHealth = tankBodySelection.tankHealthStat03;
        }
    }
    #endregion
